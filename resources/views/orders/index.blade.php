    ...
    <table id="mytable" class="display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$order->status}}</td>
                <td>
                    <a href="{{route('order.details',$order->id)}}" class="bg-amber-600 text-black px-4 py-2 rounded-lg shadow-md text-white px-2 py-1 rounded hover:shadow-blue-400 hover:text-black">View Details</a>
                    ...
                    <a onclick="return confirm('Are you sure to cancel order?')" href="{{route('order.status',[$order->id,'Cancel'])}}" class="bg-red-600 text-black px-4 py-2 rounded-lg shadow-md text-white px-2 py-1 rounded hover:shadow-red-400 hover:text-black">Cancel</a>
                </td>
            </tr>
            @endforeach
        </tbody>
