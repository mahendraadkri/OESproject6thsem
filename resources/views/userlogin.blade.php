...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Sabhai Ko ElectronicStore</title>
   ...
   <body>
      ...
      <div class="container">
        <h2 class="display-4 text-center my-4">Login</h2>
        <form action="{{ route('userlogin') }}" method="POST">
            ...
            <a href="{{ route('user.register') }}" class="text-muted">Don't have an account? Register Here</a>
        </form>
    </div>
            ...
            <div class="footer_section_2">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <div class="call_text"><img src="images/map-icon.png"><span class="paddlin_left_0"><a href="#">Gaindakot-5 Nawalpur Nepal</a></span></div>
                     <div class="call_text"><img src="images/call-icon.png"><span class="paddlin_left_0"><a href="#">+977 9865656565</a></span></div>
                     <div class="call_text"><img src="images/mail-icon.png"><span class="paddlin_left_0"><a href="#">oes500@gmail.com</a></span></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">2023 All Rights Reserved. <h2>Online Electronic Store</h2></p>
         </div>
      </div>
